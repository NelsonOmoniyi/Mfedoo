  ...
  <section class="ptb ptb-xs-60">
    <div class="container">
      <div class="row">
        <div class="col-md-8 col-lg-8 offset-md-2 text-center">
          <h2>KEEP IN TOUCH</h2>
          <p class="lead">We are determined to deliver the best solutions just to meet your needs. For more information and enquiries contact us with the details listed below!</p>
        </div>
      ...
      <div class="row">
        <div class="col-md-12 col-lg-12 contact pb-60 pt-30">
          <div class="row text-center">
            <div class="col-md-4 col-lg-4 pb-xs-30"> <i class="ion-android-call icon-circle pos-s"></i><a href="#" class="mt-15 i-block">+234 810 391 0593</a> </div>
            <div class="col-md-4 col-lg-4 pb-xs-30"> <i class="ion-ios-location icon-circle pos-s"></i>
              <p  class="mt-15"> 69 Road, Gwarinpa, <br />
                Abuja. </p>
            </div>
            <div class="col-md-4 col-lg-4 pb-xs-30"> <i class="ion-ios-email icon-circle pos-s"></i><a href="mailto:Construc@support.com"  class="mt-15 i-block">mfedoorealestateandautomobiles@gmail.com</a> </div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
		<div class="col-lg-10 col-12 ">
			<div class="fxt-contact-box-layout2 bi-map" id="map" style="width: 100%; height: 94%; border-radius: 5px; padding: 40px;">
	...
	<!-- <script>
		let center = [7.5, 9.10];
		let map = tt.map({
			key: "kXDkWfgtDV7udzE0nMuq8MkTED0oAYMx",
			container: "map",
			center: center,
			zoom: 7,
		});
	...
	<div class="container">
		...
		<div class="row footer-info mb-60">
			<div class="col-lg-6 col-md-8 col-xs-12 mb-sm-30">
				...
				<ul class="link-small">
					<li>
						<a href="mailto:business@support.com"><i class="ion-ios-email fa-icons"></i>mfedoorealestateandautomobiles <br>@gmail.com</a>
					</li>
					<li>
			...
			<div class="col-lg-6 col-md-4 col-xs-12 mb-sm-30">
				...
				<li>
					...
					<li>
						<a href="login.html"><i class="fa fa-angle-double-right"></i> Login</a>
					</li>
				</ul>
			</div>
		</div>
