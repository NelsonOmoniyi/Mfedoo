					...
					<ul>
						...
						<li data-index="rs-129">
							...
							data-responsive_offset="on" >
								<div class="banner-text">
									<span>We Think.... We Design.... We Build.... !</span>
									<h2>Welcome to Mfedoo <span> Real Estate & Automobiles</span></h2>

									<p>
										Your Comfortability Is Our Priority!
									</p>
						...
						<li data-index="rs-131">
							...
							data-responsive_offset="on" >
								<div class="banner-text">
									<span>We Think.... We Design.... We Build.... !</span>
									<h2>We are specialized in the sale of  <span>Cars</span></h2>

									
									<p>
										We take pride in the satisfaction of our clients!
									</p>
									<a class="btn-text" href="about.php"> read more</a>
								</div>
							</div>
				...
				<div class="row d-flex align-items-center">
					<div class="col-md-12 col-lg-7 about-left">
						...
						<div class="sec_hedding">
							<h2><span>About </span>Mfedoo</h2>
							<span class="b-line l-left"></span>
						</div>
						<p>
							MFEDOO Real-Estate and Automobiles is specialized in the construction, renovation and design of all kinds of buildings.  We're dedicated to providing you with the best, with a focus on dependability and durability. In-as much as we try not to sacrifice speed for quality, we are conscious of projet deadlines and we make it a goal to deliver as at when due.    
						</p>
						<div class="row mt-30">
							<div class="col-lg-4 col-md-4 process mb-40">
								...
								<div class="right-txt float-right">
									<h3>Quick Help</h3>
									<p>
										mfedoocustomercares <br> @gmail.com
									</p>
								</div>
							</div>
							...
							<div class="col-lg-4 col-md-4 process mb-40">
								<div class="icon-lf float-left">
								<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512"><path fill="currentColor" d="M256 48C141.13 48 48 141.13 48 256s93.13 208 208 208s208-93.13 208-208S370.87 48 256 48Zm96 240h-96a16 16 0 0 1-16-16V128a16 16 0 0 1 32 0v128h80a16 16 0 0 1 0 32Z"/></svg>
								</div>
								<div class="right-txt float-right">
									<h3>Events</h3>
									<p>
										Mondays - Fridays. From 8:00am to 5:00pm
									</p>
								</div>
							</div>
		...
		<section id="service_section" class="padding ptb-xs-40">
			<div class="container-fluid">
				...
				<div class="row">
						...
						<div class="maine_box">
							...
							<div class="box_detail">
								...
								<div class="datail_show">
									<h3>Construction </h3>
									<br>
									<a class="btn-text" href="request.php"> Send Us A Message </a>
								</div>
							</div>
				 ...
				 <br>
					<a class="btn-text btn-dribbble" href="services.php"> See More </a>
				 </div>
			</div>
		</section>
		<!-- OUR_Service END-->
						...
						<div id="team-carousel" class="owl-carousel team-carousel nf-carousel-theme">
							...
							<div class="team_head">
								...
								<div class="team_discoption text-center mt-15">
									<span class="team_name">Engr Ashwe Barnabas Mfeseer</span>
									<span class="postion">Chief Executive Officer (CEO)</span>
								</div>
							</div>
							...
							<div class="team_head">
								...
								<div class="team_discoption text-center mt-15">
									<span class="team_name">Mrs Ashwe Charity Dooshima</span>
									<span class="postion">Managing Director (MD)</span>
								</div>
							</div>
							...
							<div class="team_head">
								...
								<div class="team_discoption text-center mt-15">
									<span class="team_name">Ayua John Avadoo</span>
									<span class="postion">Agent</span>
								</div>
							</div>
							...
							<div class="team_head">
								...
								<div class="team_discoption text-center mt-15">
									<span class="team_name">Akende Shima</span>
									<span class="postion">Agent</span>
								</div>
							</div>
							...
							<div class="team_head">
								...
								<div class="team_discoption text-center mt-15">
									<span class="team_name">Arata Souta</span>
									<span class="postion">Agent</span>
								</div>
							</div>
						</div>
